defmodule Lawadvisor.Plug.Auth do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> LawadvisorWeb.API.Auth.generate_token(123)
      "xxxxxxx"
  ...
  ## Examples
      ...
      iex> LawadvisorWeb.API.Auth.verify_token("good-token")
      {:ok, 1}

      iex> LawadvisorWeb.API.Auth.verify_token("bad-token")
      {:error, :invalid}

      iex> LawadvisorWeb.API.Auth.verify_token("old-token")
      {:error, :expired}

      iex> LawadvisorWeb.API.Auth.verify_token(nil)
      {:error, :missing}
